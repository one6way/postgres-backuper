...
def read_from_kafka(spark, kafka_bootstrap_servers, kafka_topic):
    ...
    try:
        ...
        return spark.read \
            ...
            .option("kafka.ssl.truststore.location", "/etc/kafka/certs/truststore.jks") \
            .option("kafka.ssl.keystore.location", "/etc/kafka/certs/keystore.jks") \
            .option("kafka.ssl.truststore.password", os.environ.get("KAFKA_TRUSTSTORE_PASSWORD")) \
            .option("kafka.ssl.keystore.password", os.environ.get("KAFKA_KEYSTORE_PASSWORD")) \
